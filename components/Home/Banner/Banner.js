          ...
          <div className="w-1/3 shadow-lg">
            ...
            <div className="space-y-4 pb-6">
              ...
              <div className="mx-3">
                ...
                <div className="overflow-y-scroll h-44 space-y-3 text-lg pb-4">
                  <p>
                    জরুরী নোটিশ : ২০২০-২১ সেশনে ভর্তিচ্ছুদের সহযোগিতায় করণীয়
                  </p>
                  <p>
                   
                    ব্যবহার বিধি : সাতক্ষীরা জেলা ছাত্রকল্যাণ সমিতির ওয়েবসাইটে
                    সকলকে অভিনন্দন ! আমাদের অনেকদিনের কাঙ্খিত আনকোরা এ ওয়েবসাইট
                    পরিচালনা এবং ব্যবহার দুটোই নতুন অভিজ্ঞতা। এজন্য …{" "}
                  </p>
                  <p>
                    জরুরী নোটিশ : ২০২০-২১ সেশনে ভর্তিচ্ছুদের সহযোগিতায় করণীয়
                  </p>
